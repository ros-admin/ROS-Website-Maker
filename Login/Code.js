https://script.google.com/macros/s/AKfycbzsIMiJz8TY8nFW2YAjhCSrhNqzMEDWmmofV0mF44qa2C73FSu0IiKzqBsFatAyBEA1ZQ/exec
...
// SHA-256 সিকিউর পাসওয়ার্ড হ্যাশ ইঞ্জিন
...
// ==========================================
// ৩. মূল doGet Function (অ্যাডমিন তালিকা দেখার জন্য)
// ==========================================
function doGet(e) {
  try {
...
// ==========================================
// ৪. মূল doPost Function (রিকোয়েস্ট রাউটার)
// ==========================================
function doPost(e) {
  try {
    ...
    // 🛠 ফিক্সড এবং আপগ্রেডেড রুট: গুগল শিটের সব কলামের ডাটা অবজেক্টে পাস করা হয়েছে
...
function handleRegistration(info) {
  ...
  if (!sheet) {
    ...
    sheet.appendRow(["Member ID", "Bangla Name", "English Name", "Father Name", "Mother Name", "Mobile", "Email", "Blood Group", "Gender", "DOB", "Present Address", "Permanent Address", "Education", "Academic Year", "Profession", "Institution", "Photo URL", "WhatsApp", "Facebook", "NID/BRN", "Status", "Role", "Created At"]);
  }
  ...
  sheet.appendRow([
    ...
    info.facebookLink, info.nidOrBrn, "pending", "member", bdTime
  ]);
...
// ==========================================
// ৬. ইমেইল ডিসপ্যাচ প্রসেসর (রিয়েল-টাইম পিওর পিডিএফ রেন্ডারিং আপগ্রেড)
// ==========================================
function sendApprovalEmail(row) {
  ...
  // ==========================================
  // সার্ভার সাইড ডাটা প্রিপারেশন (পিডিএফ-এর জন্য)
  // ==========================================
  
  // ১. মেম্বার আইডি স্প্লিট করা (যেমন: ROS-2026-0003)
  ...
  // ২. মোবাইল নম্বর ডিজিট আলাদা করা (১১ ডিজিট নিশ্চিত করা)
  let cleanMobile = memberData.mobile.toString().replace(/[^0-9]/g, "");
  ...
  // ৩. জন্মতারিখ প্রসেসিং ও ডিজিট আলাদা করা
  let dobDigits = [" ", " ", " ", " ", " ", " ", " ", " "];
  let dobText = "";
  if (memberData.dob) {
  ...
  // ৪. রেজিস্ট্রেশন ডেট ডিজিট আলাদা করা
  let regDateDigits = [" ", " ", " ", " ", " ", " ", " ", " "];
  ...
  // ৫. সিকিউর রিয়েল-টাইম গুগল চার্ট এপিআই QR কোড জেনারেট করা
...
Blood: ${memberData.blood}`;
  ...
  // ৬. জেন্ডার টেক্সট ও চেকবক্সের ভ্যালু সেট করা
  ...
  // ==========================================
  // পিডিএফ এইচটিএমএল টেমপ্লেট ডাটা রিপ্লেস
  // ==========================================
  ...
  // নতুন ডাইনামিক পিওর-সার্ভার ভ্যালু ইঞ্জেকশন
  ...
  // মোবাইলের ডিজিটগুলো আলাদা আলাদা বক্সে পুশ করা
  for (let m = 0; m < 11; m++) {
    pdfHtmlTemplate = pdfHtmlTemplate.replace(`{{m${m}}}`, mDigits[m] || " ");
  }
  // DOB এর ডিজিটগুলো আলাদা আলাদা বক্সে পুশ করা
  for (let d = 0; d < 8; d++) {
    pdfHtmlTemplate = pdfHtmlTemplate.replace(`{{d${d}}}`, dobDigits[d] || " ");
  }
  // রেজিস্ট্রেশন ডেট এর ডিজিটগুলো আলাদা আলাদা বক্সে পুশ করা
  for (let r = 0; r < 8; r++) {
    pdfHtmlTemplate = pdfHtmlTemplate.replace(`{{r${r}}}`, regDateDigits[r] || " ");
  }

  // ==========================================
  // পিডিএফ জেনারেশন ও ইমেল সেন্ডিং
  // ==========================================
