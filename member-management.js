...
function exportToPDF() {
  ...
  doc.save(`ROS_Table_List.pdf`);
          ...
          // ১০০% কার্যকরী অফিশিয়াল মেম্বারশিপ ফর্ম পিডিএফ জেনারেটর (CORS ও রেন্ডারার ফিক্সড)
async function downloadOfficialTemplatePDF() {
  ...
  // ডাইনামিক অফ-স্ক্রিন কন্টেইনার তৈরি (CORS এবং ব্ল্যাঙ্ক পেজ এড়াতে ট্রান্সফর্ম ও ভিজিবিলিটি ফিক্স)
  const printWrapper = document.createElement('div');
  printWrapper.style.width = "750px";
  printWrapper.style.position = "absolute";
  printWrapper.style.left = "-9999px"; // স্ক্রিনের বাইরে পাঠিয়ে দেওয়া হলো
    ...
    <div style="border: 1px solid #0077b6; padding: 2px; background:#fff;">
      <div style="border: 1px solid #0077b6; padding: 15px; position: relative; background: #ffffff;">
        ...
        <div style="text-align: center; border-bottom: 2px solid #0077b6; padding-bottom: 6px; margin-bottom: 8px;">
          <!-- CORS সমস্যা এড়াতে crossOrigin="anonymous" অ্যাট্রিবিউট যোগ করা হয়েছে -->
          <img src="https://rosociety.vercel.app/Assets/Logo/ROS%20Logo%20Title.png" crossOrigin="anonymous" style="width: 250px; height: auto; display: block; margin: 0 auto 4px auto;">
          ...
          <tr>
            ...
            <td style="width: 80px; text-align: right; vertical-align: top;">
              <div style="width: 75px; height: 85px; border: 1px dashed #0077b6; background: #fafafa; overflow: hidden; display:inline-block;">
                <!-- মেম্বার ফটোর জন্যও crossOrigin="anonymous" যুক্ত করা হলো -->
                <img src="${u.photoUrl || 'https://rosociety.vercel.app/ros%20logo.png'}" crossOrigin="anonymous" style="width:100%; height:100%; object-fit:cover;">
              </div>
            </td>
          </tr>
        </table>
  ...
  setTimeout(async () => {
    try {
      ...
      const canvas = await html2canvas(printWrapper, { 
        scale: 2, 
        useCORS: true,        // সার্ভার থেকে ছবি নিয়ে আসার মূল অনুমতি
        allowTaint: false,    // Tainted canvas ব্লক করার জন্য false
        logging: false,
      ...
      alert("PDF ডাউনলোড ব্যর্থ হয়েছে। মেম্বার ইমেজ লিংকের CORS ইস্যুর কারণে এটি হতে পারে।");
    }
  }, 500); // QR কোড এবং ইমেজ লোড হওয়ার জন্য সময় বাড়িয়ে ৫০০ms করা হলো
                  }
